...
import { rustEnum, u64, struct, u8, bool, EnumLayout, vec } from '@project-serum/borsh'
...
export const SwapInstructionLayout: EnumLayout<SwapInstructionLayout> = rustEnum(swapInstructions)

function encodeSwapInstructionData(instruction: SwapInstructionLayout) {
...
export class SwapInstruction {
  ...
  static removeLiquidityOneToken(
    swapInfo: PublicKey,
    authority: PublicKey,
    userTransferAuthority: PublicKey,
    tokenAccounts: PublicKey[],
